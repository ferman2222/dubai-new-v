    ...
    <div class="col-lg-12">
        ...
        <div class="row mb-3">
           ...
           <div class="row mb-3">
            ...
            <div class="col-md-8">
                <div class="form-group translate">
                    <label for="">Açılış vaxtı</label>
                    <input type="hidden" name="open_hours" value='{{ $setting->open_hours }}'>
                    <input value="{{ $setting->translate('open_hours') }}"  class="form-control">
                </div>
                @error('open_hours')
                <span class="text-danger mt-2">{{ $message }}</span> <br>
                @enderror
        ...
        <div class="row mb-3">
            <div class="col-md-12">
               <div class="form-group ">
                   ...
                   <input type="text" name="xerite" class="form-control" value='{{ $setting->xerite }}'>
               </div>
               @error('fb')
               <span class="text-danger mt-2">{{ $message }}</span> <br>
               @enderror
